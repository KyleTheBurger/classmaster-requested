<template>
  ...
  >
    ...
    <v-list v-model:opened="open">
      ...
      <!-- Class Sectioning -->
      <v-list-item title="Class Sectioning" :to="{ name: 'classSectioning' }"
        ><template v-slot:prepend>
  ...
  data() {
    return {
      ...
      setupAndInitialization: [
        { title: "Domain", router_icon: "mdi-domain", router_name: "domain" },
        {
          title: "Strand",
          router_icon: "mdi-format-list-bulleted",
          router_name: "strand",
        },
        { title: "Room", router_icon: "mdi-chair-school", router_name: "room" },
      ],
      registration: [
        {
          title: "Faculty",
      ...
      management: [
        ...
        { title: "Cohort", router_icon: "mdi-school", router_name: "cohort" },
      ],
    };
  },
  watch: {
